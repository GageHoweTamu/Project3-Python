...
bool project3_interfaces__msg__person_candidates__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("project3_interfaces.msg._person_candidates.PersonCandidates", full_classname_dest, 59) == 0);
  }
  project3_interfaces__msg__PersonCandidates * ros_message = _ros_message;
  {  // positions
...
{
  /* NOTE(esteve): Call constructor of PersonCandidates */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("project3_interfaces.msg._person_candidates");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PersonCandidates");
