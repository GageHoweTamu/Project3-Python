...
static const _PersonTracks_type_support_symbol_names_t _PersonTracks_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project3_interfaces, msg, PersonTracks)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, project3_interfaces, msg, PersonTracks)),
  }
};
...
{
  return &::project3_interfaces::msg::rosidl_typesupport_cpp::PersonTracks_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, project3_interfaces, msg, PersonTracks)() {
  return get_message_type_support_handle<project3_interfaces::msg::PersonTracks>();
}
